...
| **idcard (ADR-002)** | ✅ **DEPLOYED + verified live** | 3 callables (upload/get/delete) บน Blaze · doc เก็บแค่ storagePath · client อ่าน idcard ตรง = DENIED (แก้ Storage rules overlap `kind!='idcard'`) · view ผ่าน CF base64 |
